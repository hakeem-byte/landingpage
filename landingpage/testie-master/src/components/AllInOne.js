    ...
    <div name='platforms' className='w-full my-32'>
      <div className='max-w-[1240px] mx-auto px-2'>
        ...
        <p className='text-2xl py-8 text-gray-500 text-center'>
          We provide Emailing solution to businesses and individuals
        </p>
        ...
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4'>
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Video and voice chat feature</h3>
              <p className='text-lg pt-2 pb-4'>
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Seen email feature</h3>
              <p className='text-lg pt-2 pb-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores maxime deserunt voluptatibus consequatur similique
                voluptates!
          ...
          <div className='flex'>
            ...
            <div>
              <h3 className='font-bold text-lg'>Email schedule feature</h3>
              <p className='text-lg pt-2 pb-4'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Asperiores maxime deserunt voluptatibus consequatur similique
                voluptates!
