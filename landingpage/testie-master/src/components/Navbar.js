    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          <h1 className='text-3xl font-bold mr-4 sm:text-4xl'>Emailr.</h1>
        ...
        <div className='hidden md:flex pr-4'>
          <button onClick={() => navigate("/Auth")} className='border-none bg-transparent text-black mr-4'>
            Sign In
          </button>
          <button onClick={() => navigate("/Auth")} className='px-8 py-3'>Sign Up</button>
        </div>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
        ...
        <div className='flex flex-col my-4'>
            <button className='bg-transparent text-blue-800 px-8 py-3 mb-4'>Sign In</button>
